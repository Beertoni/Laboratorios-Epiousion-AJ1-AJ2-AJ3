...
public class AgenciaPremium extends Agencia{
	...
	protected void ajustarLimiteIndividual(ContaEspecial contaEspecial) {
		...
		}else if(contaEspecial.saldo>0 && contaEspecial.saldo <5000) {
			
			contaEspecial.setLimite(contaEspecial.getLimite()-contaEspecial.getSaldo()*.30);
			
		}else if(contaEspecial.saldo>0 && contaEspecial.saldo>5000) {
			
			contaEspecial.setLimite(contaEspecial.getLimite()+contaEspecial.getSaldo()*.50);
		}
