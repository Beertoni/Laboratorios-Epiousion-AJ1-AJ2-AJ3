...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        ContaEspecial contaEsp1 = new ContaEspecial(1300,"2233",cliente1,ag1); // 1a. conta especial
        
        ContaEspecial contaEsp2 = new ContaEspecial(500,"4455",cliente2,ag1); // 2a. conta especial
        
        ContaPoupanca contaPoup = new ContaPoupanca(2000,"6677",cliente1,ag1,"25/09/1998"); // conta poupanca
